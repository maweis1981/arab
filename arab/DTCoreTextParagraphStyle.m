...
- (id)initWithCTParagraphStyle:(CTParagraphStyleRef)ctParagraphStyle
{
	...
	if (self)
	{
        ...
        CTParagraphStyleGetValueForSpecifier(ctParagraphStyle, kCTParagraphStyleSpecifierMinimumLineSpacing, sizeof(minimumLineSpacing), &minimumLineSpacing);
		CTParagraphStyleGetValueForSpecifier(ctParagraphStyle, kCTParagraphStyleSpecifierMaximumLineSpacing, sizeof(maximumLineSpacing), &maximumLineSpacing);
...
//    CGFloat firstLineHeadIndent = 20.0;
//    
...
//
	...
	CTParagraphStyleSetting settings[] = 
	{
		...
		{kCTParagraphStyleSpecifierMaximumLineSpacing, sizeof(maximumLineSpacing), &maximumLineSpacing},
...
- (id)copyWithZone:(NSZone *)zone
{
    ...
    newObject.minimumLineSpacing = self.minimumLineSpacing;
    newObject.maximumLineSpacing = self.maximumLineSpacing;
